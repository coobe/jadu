...
<div id="register-user-dialog" class="modal-dialog" title="Register a new User">
   ...
   <form onsubmit="event.preventDefault();">
        <div class="row">
            <label class="col-md-4 label label-default">Name</label>
            <input id="user-name" type="text" name="user-name" autocomplete="off" required />
        </div>
        <div class="row">
            <label class="col-md-4 label label-default" >Password</label>
            <input id="register-password" type="password" name="register-password" autocomplete="off" required />
        </div>
       <div class="row">
            <label class="col-md-4 label label-default">repeat Password</label>
            <input id="confirm-password" type="password" name="password-confirm" autocomplete="off" required />
        </div>
        <div class="row">
            <button id="modal-register-user" class="col-md-3 col-md-offset-4 btn btn-primary" name="register">Register</button>
        </div>
    </form>
</div>